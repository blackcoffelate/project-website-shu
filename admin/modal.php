            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Data Pemasukan Modal</a>
                    </div>
                    <!-- start navbar -->
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="card-header card-header-danger">
                                            <h4 class="card-title">Data Pemasukan Modal</h4>
                                            <p class="card-category">Data Pemasukan Modal Koperasi Bina Arta Mandiri</p>
                                            <a href="modal_add" class="btn btn-warning"><i class="material-icons">add</i> Tambah Modal</a>
