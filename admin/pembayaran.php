                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="card-header card-header-danger">
                                            ...
                                            <p class="card-category">Data Pembayaran Koperasi Bina Arta Mandiri</p>
                                            <!-- <a href="anggota_add" class="btn btn-warning"><i class="material-icons">add</i> Tambah Pembayaran</a> -->
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <table id="example1" class="display nowrap" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Rp. 200.000</td>
                                                                <td>
                                                                    <a href="pembayaran_add" type="button" rel="tooltip" title=""
                                                                        class="btn btn-warning btn-link btn-sm"
                                                                        data-original-title="Bayar">
