            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Pengguna</a>
                    </div>
                    <!-- start navbar -->
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="card-header card-header-danger">
                                            ...
                                            <p class="card-category">Data Pengguna Koperasi Bina Arta Mandiri</p>
                                            <a href="pengguna_add" class="btn btn-warning"><i
                                                    class="material-icons">add</i> Tambah Pengguna</a>
                                        </div>
                                        <div class="card-body">
