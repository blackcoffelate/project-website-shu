                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="card-header card-header-danger">
                                            ...
                                            <p class="card-category">Data Simpanan Koperasi Bina Arta Mandiri</p>
                                            <!-- <a href="anggota_add" class="btn btn-warning"><i
                                                    class="material-icons">add</i> Tambah Simpanan</a> -->
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <table id="example1" class="display nowrap" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>5</td>
                                                                <td>
                                                                    <a href="simpan_pinjam_add" type="button" rel="tooltip" title=""
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="card-header card-header-danger">
                                            ...
                                            <p class="card-category">Data Pinjaman Koperasi Bina Arta Mandiri</p>
                                            <a href="pinjaman_add" class="btn btn-warning"><i class="material-icons">add</i> Tambah Pinjaman</a>
                                        </div>
                                        <div class="card-body">
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="profile">
